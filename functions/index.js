/**
 * 福といっしょ LINE通知機能 Backend (v2.9.1 - Refactored to v2)
 */
...
exports.notifyWalkStart = onCall(async (request) => {
...
exports.onHealthWrite = onDocumentWritten("health/{healthId}", async (event) => {
